...
def render_page(
    ...
    return "\n".join([
        ...
        "    body{font-size:1.6rem;padding:3.2rem;display:flex;justify-content:center}",
        ...
        "    .sl-cta{display:inline-flex;align-items:center;justify-content:center;background:#16a34a;color:#fff;border:0;border-radius:0.8rem;padding:1.4rem 1.8rem;font-weight:700;text-decoration:none}",
